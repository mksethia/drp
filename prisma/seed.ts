...
async function main() {
  ...
  const clubsData = [
    ...
    },
    {
      ...
      facilitiesImage: 'https://www.afcoakley.co.uk/wp-content/uploads/2023/02/Oakley_Team_3-scaled_1080x600_acf_cropped.jpg',
      social: 'Very Social',
      cost: 25,
      isElite: false,
    },
    {
      ...
      facilitiesImage: 'https://www.alexandraparkfc.co.uk/wp-content/uploads/2022/11/2022_10_30_AP_JPEG-8-bit-300ppi-sRGB-For-Web_00021-1024x683.jpg',
    ...
    },
    {
      ...
      facilitiesImage: 'https://www.ayrrugbyclub.co.uk/wp-content/uploads/2021/09/report1-scaled.jpg',
      social: 'Social',
      cost: 143,
      isElite: false,
    },
